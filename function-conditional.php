...
<body>
    ...
    */
    ...
    function reverse($kata1) {
        ...
        $tampungKata =  "";
        for($kata = ($panjangKata - 1); $kata >= 0; $kata--) {
            $tampungKata .= $kata1[$kata];
        }
    ...
    */
    ...
    function palindrome($string) {
        $panjangKarakter = strlen($string);
        
        for ($i = 0; $i < $panjangKarakter / 2; $i++) {
            // Membandingkan karakter dari awal dan akhir
            if ($string[$i] !== $string[$panjangKarakter - $i - 1]) {
                return "false";
            }
        }
